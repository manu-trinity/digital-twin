...
def generate_launch_description():
    ...
    spawn_joint_state_broadcaster_timer = TimerAction(
            period=20.0,
    ...
    launch_husky_control_timer = TimerAction(
            period=10.0,
            actions=[launch_husky_control],
        )
    ...
    ld.add_action(spawn_joint_state_broadcaster_timer)
